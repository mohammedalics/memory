...
/**
 * The Class PrintAllInterpreterTest.
 */
@RunWith(SpringRunner.class)
@ActiveProfiles("test")
@SpringBootTest
public class PrintAllInterpreterTest {
	...
	public void interpretTest() {
		try {
			...
			given(employeeRepository.findAllByOrderByNameAsc()).willReturn(empList);
			printAllInterpreter.interpret("asc");
			assertThat(outContent.toString(), CoreMatchers.startsWith("Name:Amin"));
		} catch (Exception e) {
			e.printStackTrace();
			assertTrue(false);
